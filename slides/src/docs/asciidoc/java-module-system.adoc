...
[size175]#*Using Gunnar Morling's https://github.com/moditect/moditect/blob/master/README.md[ModiTect]*#
...
[size125]#*Code and slides of this talk: https://github.com/beryx/talk-jaxlondon-2019*#
